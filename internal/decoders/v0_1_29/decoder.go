// Package v0_1_29 is the Phase-D delegating adapter for poktroll v0.1.29.
...
// Decoder implements decoders.Decoder for poktroll v0_1_29.
type Decoder struct{}

// Version returns the canonical version tag for this decoder package.
func (Decoder) Version() string { return "v0_1_29" }
