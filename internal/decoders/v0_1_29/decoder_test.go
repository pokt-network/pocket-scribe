...
func TestVersion(t *testing.T) {
	if got := (Decoder{}).Version(); got != "v0_1_29" {
		t.Fatalf("Version() = %q, want v0_1_29", got)
	}
}
...
// TestDelegateSupplierMsgDelegates confirms the v0_1_29 delegation path for
...
// TestDelegateSupplierEventDelegates confirms the v0_1_29 delegation path for
...
// TestDelegateSupplierKVDelegates confirms the v0_1_29 delegation path for
