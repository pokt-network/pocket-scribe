// Package v0_1_28 is the Phase-D delegating adapter for poktroll v0.1.28.
...
// Decoder implements decoders.Decoder for poktroll v0_1_28.
type Decoder struct{}

// Version returns the canonical version tag for this decoder package.
func (Decoder) Version() string { return "v0_1_28" }
