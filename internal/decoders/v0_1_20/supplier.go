...
// DecodeSupplierMsg implements decoders.Decoder; delegates to v0_1_8.
...
// DecodeSupplierEvent implements decoders.Decoder; delegates to v0_1_8.
...
// DecodeSupplierKV implements decoders.Decoder; delegates to v0_1_8.
