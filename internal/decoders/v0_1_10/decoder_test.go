...
func TestVersion(t *testing.T) {
	if got := (Decoder{}).Version(); got != "v0_1_10" {
		t.Fatalf("Version() = %q, want v0_1_10", got)
	}
}
...
// TestDelegateSupplierMsgDelegates confirms the v0_1_10 delegation path for
// DecodeSupplierMsg is wired (foreign typeURL → (nil, nil) from v0_1_8 owner).
...
// TestDelegateSupplierEventDelegates confirms the v0_1_10 delegation path for
// DecodeSupplierEvent is wired (unknown type → (nil, nil) from v0_1_8 owner).
...
// TestDelegateSupplierKVDelegates confirms the v0_1_10 delegation path for
// DecodeSupplierKV is wired (index key → (nil, nil) from v0_1_8 owner).
