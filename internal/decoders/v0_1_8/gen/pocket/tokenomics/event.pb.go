...
func (m *EventClaimExpired) GetClaimedUpokt() *types.Coin {
	if m != nil {
...
type EventClaimSettled struct {
	...
	ProofRequirement proof.ProofRequirementReason `protobuf:"varint,2,opt,name=proof_requirement,json=proofRequirement,proto3,enum=pocket.proof.ProofRequirementReason" json:"proof_requirement"`
	// Number of relays claimed to be in the session tree.
	NumRelays uint64 `protobuf:"varint,3,opt,name=num_relays,json=numRelays,proto3" json:"num_relays"`
	// Number of compute units claimed as a function of the number of relays
	// and the compute units per relay for the particular service.
...
func (m *EventClaimSettled) GetClaimedUpokt() *types.Coin {
	if m != nil {
		return m.ClaimedUpokt
	}
	return nil
...
type EventApplicationOverserviced struct {
	...
	ExpectedBurn *types.Coin `protobuf:"bytes,3,opt,name=expected_burn,json=expectedBurn,proto3" json:"expected_burn,omitempty"`
	...
	EffectiveBurn *types.Coin `protobuf:"bytes,4,opt,name=effective_burn,json=effectiveBurn,proto3" json:"effective_burn,omitempty"`
}
...
type EventSupplierSlashed struct {
	...
	ProofMissingPenalty *types.Coin `protobuf:"bytes,2,opt,name=proof_missing_penalty,json=proofMissingPenalty,proto3" json:"proof_missing_penalty,omitempty"`
}
...
func (m *EventSupplierSlashed) GetClaim() *proof.Claim {
	if m != nil {
		return m.Claim
	}
	return nil
...
func (m *EventSupplierSlashed) GetProofMissingPenalty() *types.Coin {
	if m != nil {
...
func (m *EventApplicationReimbursementRequest) GetAmount() *types.Coin {
	if m != nil {
		return m.Amount
	}
	return nil
...
var fileDescriptor_146818b9f891ddf6 = []byte{
	...
	,
}
